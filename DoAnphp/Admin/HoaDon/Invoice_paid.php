...
include('./Function/Function.php');
    ...
    khach_hang AS kh ON kh.MaKH=hdb.MaKH WHERE hdb.TinhTrangDuyet=1";
    $nowpage_layout='invoicepaid';
    $query='';
                                ...
                                <div class="modal-dialog" role="document">
                                  <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                      ...
                                      <button type="submit" class="btn btn-primary" name="submitupdateivp">Save changes</button>
                                    </div>
                                    </form>
                                  </div>
                                </div>
