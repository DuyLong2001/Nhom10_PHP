    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php?page_layout=home"><img src="./assets/images/bluemusic.png" alt="logo" /></a>
          <a class="navbar-brand brand-logo-mini" href="index.php?page_layout=home"><img src="./assets/images/bluemusic-mini.png" alt="logo" /></a>
        </div>
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-toggle="collapse" href="#general-pages" aria-expanded="false" aria-controls="general-pages">
                <span class="menu-title">Quản lý nhạc cụ</span>
                <i class="menu-arrow"></i>
              ...
              <div class="collapse" id="general-pages">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="index.php?page_layout=lnc"> Loại nhạc cụ </a></li>
