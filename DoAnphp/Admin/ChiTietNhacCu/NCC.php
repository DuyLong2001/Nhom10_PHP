        ...
        ?>    
                        <tbody>
                          ...
                          <div class="modal fade" id="editncc<?php echo $rows2['MaNCC']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <!---------------------------END-------------------------->
                                <form action="" method="post">
                                <a onclick="return delete_advance();" href="./ChiTietNhacCu/XuLy.php?id_ncc=<?php echo $rows2['MaNCC']?>" type="button" class="btn btn-gradient-success btn-sm" name="deletencc">Delete</a>
