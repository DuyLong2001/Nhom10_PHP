        ...
        ?>    
                        <tbody>
                          ...
                          <div class="modal fade" id="edithsx<?php echo $rows1['MaHSX']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                ...
                                <!---------------------------END-------------------------->
                                <form action="" method="post">
                                <a onclick="return delete_advance();" href="./ChiTietNhacCu/XuLy.php?id_hsx=<?php echo $rows1['MaHSX']?>" type="button" class="btn btn-gradient-success btn-sm" name="deletehsx">Delete</a>
