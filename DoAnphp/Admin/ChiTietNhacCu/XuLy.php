...
{   
    if(isset($_POST['TenLoaiNC']) and !empty($_POST['TenLoaiNC'])){
...
/////////////////////Xóa loại nhạc cụ
    ...
    $querys_run1=mysqli_query($conn,"DELETE FROM `nhac_cu` WHERE MaLoaiNC=$idlnc");
    $querys = "DELETE FROM loai_nhac_cu WHERE MaLoaiNC=$idlnc";
...
///////////////////Xóa hãng sản xuất
    ...
    if($idhsx!=null){
        $querys_run1=mysqli_query($conn,"DELETE FROM `nhac_cu` WHERE MaHSX=$idhsx");
...
if($idncc!=null){
    $querys_run1=mysqli_query($conn,"DELETE FROM `nhac_cu` WHERE MaNCC=$idncc");
