...
INSERT INTO `chi_tiet_hoa_don_ban` (`SoHD`, `MaNC`, `SoLuong`, `DonGia`) VALUES
(252, 2, 1, 27280000),
(252, 3, 1, 7300000),
(253, 2, 2, 27280000),
(253, 3, 3, 7300000),
...
(252, '2022-12-02 08:57:42', NULL, 8, NULL, 0, 0),
...
(8, 'Trần Ngọc Duy Long', '0123121', 'long1972001@gmail.com', '34 Vĩnh Thái Nha Trang', 'duylongpro123', '756b6c48a100066bb8a4428c4937e281', '');
...
--
ALTER TABLE `hoa_don_ban`
  MODIFY `SoHD` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=255;
...
--
ALTER TABLE `loai_nhac_cu`
  MODIFY `MaLoaiNC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `nhac_cu`
--
ALTER TABLE `nhac_cu`
  MODIFY `MaNC` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
