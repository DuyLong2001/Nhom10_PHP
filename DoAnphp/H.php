		...
		<div id="top-header">
			<div class="container">
				<ul class="header-links pull-left">
					...
					<li><a href="#"><i class="fa fa-envelope-o"></i> hung.nt.61cntt@ntu.edu.vn</a></li>
						...
						<div class="header-search">
							<form method="POST">
								<select class="input-select" name="input-select">
									...
									<?php
									if (mysqli_num_rows($resultloainhaccu) != 0) {
										while ($row = mysqli_fetch_array($resultloainhaccu)) {
									?>
											<option <?php if (isset($loainc) and $row["MaLoaiNC"] == $loainc) echo "selected='selected' "; ?> value="<?php echo $row["MaLoaiNC"] ?>"> <?php echo $row["TenLoaiNC"] ?>
											</option>
									<?php
										}
									}
